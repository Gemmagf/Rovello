      ...
      <div className="container mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-4">  
        <div className="flex items-center gap-4">  
          ...
          <div>  
            ...
            <p className="text-green-100 font-medium">Detecta si tu hongo es amigo o villano – ¡o solo un impostor!</p>  
          </div>  
        </div>  
        <motion.div  
        ...
        >  
          ⚠️ Esto no es consejo médico – ¡investiga más, no seas loco!  
        </motion.div>  
      </div>  
    </motion.div>  
  );  
